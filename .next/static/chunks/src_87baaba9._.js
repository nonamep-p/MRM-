...
function PackageDetailsPage({ params: { id } }) {
    ...
    const travelPackage = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["travelPackages"].find((p)=>p.id === id);
    if (!travelPackage) {
...
_s(PackageDetailsPage, "Z9Vscua01a1hW3Hn/YUvItAw+dk=");
...
//# sourceMappingURL=src_87baaba9._.js.map